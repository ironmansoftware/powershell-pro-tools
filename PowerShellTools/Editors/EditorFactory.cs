...
namespace PowerShellTools.Editors
{
    ...
    /// </summary>
    [Guid(GuidList.guidCustomEditorEditorFactoryString)]
    public sealed class EditorFactory : IVsEditorFactory, IDisposable
    {
        private PowerShellToolsPackage editorPackage;
                        ...
                        out int pgrfCDW)
        {
            ...
            pguidCmdUI = GuidList.guidCustomEditorEditorFactory;
            pgrfCDW = 0;
            ...
            EditorPane NewEditor = new EditorPane(editorPackage, pszMkDocument);
