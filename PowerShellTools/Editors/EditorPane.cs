...
namespace PowerShellTools.Editors
{
    ...
    //       our case we chose PowerShell-Help.xml.xml. Note this file name appears in Editor.vsdir
    ...
    //          - "PowerShell-Help.xml" - This is the base file name. New files will initially
    //             be named as PowerShell-Help.xml1.xml, PowerShell-Help.xml2.xml... etc.
    ///////////////////////////////////////////////////////////////////////////////
    // Editor.vsdir contents:-
    //    PowerShell-Help.xml.xml|{3085E1D6-A938-478e-BE49-3546C09A1AB1}|#106|80|#109|0|401|0|#107
    //
    // The fields in order are as follows:-
    //    - PowerShell-Help.xml.xml - our empty xml file
                                ...
                                IVsToolboxUser      //Sends notification about Toolbox items to the owner of these items
    {
        ...
        #region Fields
        private PowerShellToolsPackage myPackage;
        ...
        {
            pClassID = GuidList.guidCustomEditorEditorFactory;
