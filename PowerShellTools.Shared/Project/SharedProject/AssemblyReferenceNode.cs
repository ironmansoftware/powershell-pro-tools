    ...
    internal class AssemblyReferenceNode : ReferenceNode {
        ...
        private void GetPathNameFromProjectFile() {
            ...
            if (String.IsNullOrEmpty(result)) {
                ...
                if (String.IsNullOrEmpty(result)) {
                    result = this.ItemNode.GetMetadata(ProjectFileConstants.Name);
                    if (String.IsNullOrEmpty(result))
                    {
                    ...
                    {
                        result += ".dll";
                        this.assemblyPath = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.ProgramFilesX86), "Reference Assemblies", "Microsoft", "Framework", ".NETFramework", "v4.7.2", result);
