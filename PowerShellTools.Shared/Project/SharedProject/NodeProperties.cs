...
namespace Microsoft.VisualStudioTools.Project {
    ...
    public class FileNodeProperties : NodeProperties {
        ...
        [Description("Whether to embed this file as a resource.")]
        public bool Resource
        {
            get
            {
                return bool.TryParse(((HierarchyNode)Node).ItemNode.GetMetadata("Resource"), out bool value) && value;
            }
            set
            {
                ((HierarchyNode)Node).ItemNode.SetMetadata("Resource", value.ToString());
            }
        }
