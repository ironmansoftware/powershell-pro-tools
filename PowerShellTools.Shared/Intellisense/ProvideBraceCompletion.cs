...
{
    /// <summary>
    /// Enable setting for Automatic brace completion under Options\Text Editor\PowerShell
    /// </summary>
    internal class ProvideBraceCompletionAttribute : RegistrationAttribute
    {
