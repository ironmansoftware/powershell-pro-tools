...
```
Open-VSCodeTextDocument -FileName <String> [-Wait] [-ResponseTimeout <Int32>]
 [-ProgressAction <ActionPreference>] [<CommonParameters>]
```

## DESCRIPTION
Given a file path, the cmdlet opens the document to edit.
...
Opens the file 'form.designer.ps1' to edit.

## PARAMETERS

### -FileName
The file path to open, whether relative or absolute.
